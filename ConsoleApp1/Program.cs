...
class Program
{
    ...
    public static void GuardarDatosConTransaccion()
    {
        SchoolContext context = new SchoolContext();
        using (var dbContextTransaction = context.Database.BeginTransaction())
        {
            try
            {
                ...
                Address address = new Address { Street = "123 Main St", City = "City", State = "State" };
                Contact contact = new Contact { Email = "john.doe@example.com", Phone = "1234567890" };
